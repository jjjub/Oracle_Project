...
INSERT INTO tblUser (userpk, role, name, bdate, tel, id, pw, regdate) VALUES ( (SELECT NVL(MAX(userpk), 0) + 1 FROM tblUser), '학생', '다온윤', TO_DATE('1999-05-12', 'YYYY-MM-DD'), '01038075620', 'daon456', '2164597', SYSDATE);
