...
ALTER table tblOpenCourse ADD CONSTRAINT FK_tblCourse_TO_tblOpenCourse FOREIGN KEY (crspk)
REFERENCES tblCourse (crspk);
...
create table tblRecruit (
 	...
 	result varchar2(10)  DEFAULT '미정' NOT NULL,
...
ALTER table tblGrade ADD CONSTRAINT FK_tblStudent_TO_tblGrade FOREIGN KEY (stupk)
...
create table tblBoard (
	...
	boardtype varchar2(15) NOT NULL,
	regdate date NOT NULL,
...
alter table tblboard modify boardtype varchar2(15);
...
--DROP TABLE "TBLRESEARCH" CASCADE CONSTRAINTS;
...
--DROP TABLE "TBLBOOKRECOMMEND" CASCADE CONSTRAINTS;
--DROP TABLE "TEMP" CASCADE CONSTRAINTS;
--DROP TABLE "TBLTEMP" CASCADE CONSTRAINTS;
